...
class ParticipantTest < ActiveSupport::TestCase
	...
	class Participants < ActiveRecord::Base
	  	...
	  	validates_presence_of :fname, :lname, :phone, :birthday
	end
# --------- USER STORY 10 ----------------------------
	
	# Test a valid new member without email saving in the participants database
	def test_valid_new_member_nil_email
		participant = Participant.new(:participantID => "kikiko01", :fname =>"Kiki", :lname =>"Ko", :phone => 4169876256, :expirydate => 2013-12-01, :dr_note_date => Date.today, :password => "mypassword", :email => nil, :birthday => 2000-10-18)
	...
	def test_valid_new_member_with_email
		participant = Participant.new(:participantID => "kikiko02", :fname =>"Kiki", :lname =>"Ko", :phone => 4169876256, :expirydate => 2013-12-01, :dr_note_date => Date.today, :password => "mypassword", :email => "kiki.koko@email.com", :birthday => 2000-10-18)
	...
	def test_unvalid_new_member
		participant = Participant.new(:participantID => "kungfu", :fname => "Haro", :lname => "There", :phone => 9999999999, :expirydate => nil, :dr_note_date => nil, :password => nil, :email => nil, :birthday => 1930-04-04)
	...
	def test_null_new_member
		participant = Participant.new(:participantID => nil, :fname => nil, :lname => nil, :phone => nil, :expirydate => nil, :dr_note_date => nil, :password => nil, :email => nil, :birthday => nil)
